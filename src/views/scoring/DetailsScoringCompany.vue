  ...
  methods: {
    async fetchData() {
      try {
        ...
        this.scoreTotalNow = (response[0].scoreTotalNow * 100).toFixed(2);
        this.scoreTotalEngagement = (response[0].scoreTotal2Years * 100).toFixed(2);
        this.scoreTotalTotal = (response[0].totalTotal*100).toFixed(2);
