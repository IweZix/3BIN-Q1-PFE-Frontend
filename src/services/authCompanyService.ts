...
export const answerForm = async (token: string, answers: any) => {
    try {
        const response = await axios.post(`${API_URL}/answerForm`, { listQuestions : answers.questions }, {
            headers: {
                Authorization: `${token}`,
            },
        });
...
export const answerFormCompleted = async (token: string, answers: any) => {
    try {
        const response = await axios.post(`${API_URL}/answerFormCompleted`, { listQuestions : answers.questions }, {
            headers: {
                Authorization: `${token}`,
            },
        });
